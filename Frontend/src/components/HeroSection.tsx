...
export function HeroSection({ prompt, setPrompt }: HeroSectionProps) {
  ...
  return (
    <header className="relative z-10 px-6 py-24 md:pt-48 pt-24 md:mb-20">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
       <h1 className="text-4xl md:text-6xl font-extrabold text-white leading-tight tracking-tight text-center">
  ...
  <div className="mt-4 flex justify-center">
    <span className="inline-block px-4 py-2 text-lg font-semibold text-white bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full shadow-lg animate-pulse">
      Powered by <span className="text-yellow-300">A<span className="animate-bounce inline-block">!</span></span>
    </span>
  </div>
</h1>
